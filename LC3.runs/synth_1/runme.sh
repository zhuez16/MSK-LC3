...
HD_PWD='D:/homework/vivado/exp10/LC3/LC3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log init.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source init.tcl
