...
HD_PWD='D:/homework/vivado/exp10/LC3/LC3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log init.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source init.tcl -notrace
