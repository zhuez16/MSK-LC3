...
--               D:/homework/vivado/exp10/LC3/LC3.srcs/sources_1/ip/dist_mem_gen_0_1/dist_mem_gen_0_sim_netlist.vhdl
...
ram_reg_0_127_0_0: unisim.vcomponents.RAM128X1S
    generic map(
      INIT => X"0000000000000000000000000001AA38"
    )
        port map (
      A0 => a_reg(0),
      A1 => a_reg(1),
...
ram_reg_0_127_10_10: unisim.vcomponents.RAM128X1S
    generic map(
      INIT => X"0000000000000000000000000000C4B6"
    )
        port map (
      A0 => a_reg(0),
      A1 => a_reg(1),
...
ram_reg_0_127_11_11: unisim.vcomponents.RAM128X1S
    generic map(
      INIT => X"00000000000000000000000000008C40"
    )
        port map (
      A0 => a_reg(0),
      A1 => a_reg(1),
...
ram_reg_0_127_12_12: unisim.vcomponents.RAM128X1S
    generic map(
      INIT => X"00000000000000000000000000017A5F"
    )
        port map (
      A0 => a_reg(0),
      A1 => a_reg(1),
...
ram_reg_0_127_14_14: unisim.vcomponents.RAM128X1S
    generic map(
      INIT => X"00000000000000000000000000011041"
    )
        port map (
      A0 => a_reg(0),
      A1 => a_reg(1),
...
ram_reg_0_127_15_15: unisim.vcomponents.RAM128X1S
    generic map(
      INIT => X"00000000000000000000000000010800"
    )
        port map (
      A0 => a_reg(0),
      A1 => a_reg(1),
...
ram_reg_0_127_1_1: unisim.vcomponents.RAM128X1S
    generic map(
      INIT => X"0000000000000000000000000000CC64"
    )
        port map (
      A0 => a_reg(0),
      A1 => a_reg(1),
...
ram_reg_0_127_2_2: unisim.vcomponents.RAM128X1S
    generic map(
      INIT => X"00000000000000000000000000011980"
    )
        port map (
      A0 => a_reg(0),
      A1 => a_reg(1),
...
ram_reg_0_127_3_3: unisim.vcomponents.RAM128X1S
    generic map(
      INIT => X"00000000000000000000000000000820"
    )
        port map (
      A0 => a_reg(0),
      A1 => a_reg(1),
...
ram_reg_0_127_4_4: unisim.vcomponents.RAM128X1S
    generic map(
      INIT => X"00000000000000000000000000008802"
    )
        port map (
      A0 => a_reg(0),
      A1 => a_reg(1),
...
ram_reg_0_127_5_5: unisim.vcomponents.RAM128X1S
    generic map(
      INIT => X"0000000000000000000000000001881F"
    )
        port map (
      A0 => a_reg(0),
      A1 => a_reg(1),
...
ram_reg_0_127_6_6: unisim.vcomponents.RAM128X1S
    generic map(
      INIT => X"0000000000000000000000000000A81F"
    )
        port map (
      A0 => a_reg(0),
      A1 => a_reg(1),
...
ram_reg_0_127_7_7: unisim.vcomponents.RAM128X1S
    generic map(
      INIT => X"0000000000000000000000000000C010"
    )
        port map (
      A0 => a_reg(0),
      A1 => a_reg(1),
...
ram_reg_0_127_9_9: unisim.vcomponents.RAM128X1S
    generic map(
      INIT => X"0000000000000000000000000000A53B"
    )
        port map (
      A0 => a_reg(0),
      A1 => a_reg(1),
